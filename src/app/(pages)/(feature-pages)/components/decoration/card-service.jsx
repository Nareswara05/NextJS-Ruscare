...
const CardService = ({ title, description }) => {
    ...
    return (
        <div>
            <div className='group hover:scale-105   bg-white px-7 py-10 relative w-[350px] rounded-xl transition-all duration-300 hover:bg-secondary overflow-hidden cursor-pointer' onClick={handleClick}>
                <div className='flex justify-between'>
                    <div className='flex flex-col gap-2'>
                        <h1 className='text-primary text-[20px] min-w-max font-bold transition-colors duration-300 group-hover:text-white'>{title}</h1>
